...
code can be edited locally and pushed to GitHub where the CI/CD workflow will automatically test, build and push the application container image to Google's Container Registry (GCR), and update the live application running on Cloud Run directly. 
